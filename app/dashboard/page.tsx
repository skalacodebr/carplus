      ...
      <div className="flex-1 p-4">
        {activeTab === "calculadora" && (
          <div className="space-y-4">
            ...
            {calculationResult && (
              <div
                className="w-full py-3 px-4 rounded-full text-center text-white mt-2"
            ...
            <div className="flex justify-center mt-2">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecop="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Ver histórico
              </Link>
            </div>
